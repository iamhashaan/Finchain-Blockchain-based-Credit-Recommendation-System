		...
		<div class="container">
			...
			<div class="contact-grids">
				...
				<form action="personalData" method="post">
					<input type="text" value="${msg1}" required="required"
							name="username" readonly="readonly"/> <br>
							<input type="text" placeholder="Date of Birth" required="required"
							name="dob" id="datepicker" /> <br>
							...
							name="state" /> <br>
							<input type="text" placeholder="ZipCode" required="required"
							name="pincode" /> <br>
							<input type="text" placeholder="Country" required="required"
							name="country" /> <br>
							<input type="hidden" placeholder="Country" value="${msg }"
							name="type" /> <br>
				...
				<div class=" col-md-6 map">
					<img
						src="${pageContext.request.contextPath}/resources/images/personal info.jpg" style="width: 70%"></img>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
