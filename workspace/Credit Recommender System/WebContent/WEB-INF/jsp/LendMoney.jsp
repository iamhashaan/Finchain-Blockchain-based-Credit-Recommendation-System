		...
		<div class="container">
			...
			<div class="contact-grids">
			 ...
			 <c:forEach var="list" items="${list}">
						<c:if test="${list.status=='Accept' }">
			
			<form action="lendLoan" method="get">
				
					
		
						<div class=" col-md-6 contact-form">
						<h6>Borrower Name</h6>
						<input type="text" placeholder="Full name" readonly="readonly"
							value="${list.lender_name }"  name="borrower_name"/>
							
							<input type="hidden" placeholder="Full name" readonly="readonly"
							value="${list.usename }"  name="username"/>
							
							
							
								<h6>Lendeing Type</h6>
							<input type="email" placeholder="Your mail"
							 readonly="readonly" value="${list.types }" name="types" /> 
				...
				<div class=" col-md-6 contact-form">
								...
								<h6>Duration</h6>
							<input type="text"
							placeholder="Phone number"  readonly="readonly" value="${list.dues }" name="dues" /> 
								<h6>Amount</h6>
							<input
							type="text" placeholder="UserName"  readonly="readonly"
							value="${list.amount }" name="amount" /> 
