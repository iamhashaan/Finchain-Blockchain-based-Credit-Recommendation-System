	...
	<div class="team" id="team">
		...
		<table id="customers" align="center">
			...
			<c:forEach var="list" items="${list}">
				...
				<c:if test="${list.status.equalsIgnoreCase('Accepted') }">
					<tr>
						<td>${list.lender_name}</td>
						<td>${list.dues}</td>
						<td>${list.amount}</td>
						<td><a
							href="viewPayment/${list.lender_name}/${list.dues}/${list.amount}/${list.usename}/${list.types}">ViewPayment
								Details</a></td>
								
								<td><a
							href="feedback/${list.lender_name}/${list.usename}">Feedback</a></td>
					</tr>
				</c:if>
