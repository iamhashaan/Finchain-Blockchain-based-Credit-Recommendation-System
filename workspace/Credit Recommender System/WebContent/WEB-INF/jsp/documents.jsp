			...
			<div class="contact-grids" align="center">
				<div class=" col-md-6 contact-form" align="center">
					...
					<br>
						...
						<br>
						<br>
						<h5 style="color: yellow;">PanCard</h5>
						<br>
						<input type="file" id="file" name="file2"  /> 
						<input type="text" placeholder="PanCard No" name="pan"  /> 
							
						<br>
						<br>
						
						<h5 style="color: yellow;">Profile Picture</h5>
						<br>
