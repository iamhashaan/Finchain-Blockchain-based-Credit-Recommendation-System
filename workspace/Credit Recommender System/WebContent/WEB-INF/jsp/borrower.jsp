...
<div class="team" id="team">
		...
		<c:if test="${msg.type=='prospective lenders' }">
					...
					<div class="gal-text-box">
						<div class="info-gal-con">
							<div class="social-content">
								<ul>
									<li class="facebook"><a class="ico1 hvr-underline-from-center" href="viewLender/${msg.username}/${msg.type}"><i class="fa fa-eye" aria-hidden="true"></i></a></li>
									<li class="twitter"><a class="ico2 hvr-underline-from-center" href="checkLender/${msg.username}/${msg.type}/${msg1}"><i class="fa fa-check" aria-hidden="true"></i></a></li>
									<li class="twitter"><a class="ico2 hvr-underline-from-center" href="viewPolicy/${msg.username}/${msg.type}/${msg1}"><i class="fa fa-money" aria-hidden="true"></i></a></li>
									<li class="twitter"><a class="ico2 hvr-underline-from-center" href="viewMoney/${msg.username}/${msg.type}/${msg1}"><i class="fa fa-bell" aria-hidden="true"></i></a></li>
