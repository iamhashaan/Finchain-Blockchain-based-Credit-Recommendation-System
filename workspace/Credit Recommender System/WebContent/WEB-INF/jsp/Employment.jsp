...
<body>
    ...
    <option value="volvo">Type Of Lending</option>
	...
	<select name="dues" id="cars" style="width:100">
    <option  >No Of Dues</option>
    ...
    <option value="12 months">12 Months</option>
				...
				<div class=" col-md-6 contact-form">
						 ...
						 <input type="text"placeholder="Enter Amount" required="required" 
							name="amount" /> 
